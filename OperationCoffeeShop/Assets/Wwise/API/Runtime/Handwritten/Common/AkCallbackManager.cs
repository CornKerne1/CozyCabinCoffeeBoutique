...
public static class AkCallbackManager
{
    ...
    private static readonly AkEventCallbackInfo
        AkEventCallbackInfo = new AkEventCallbackInfo(System.IntPtr.Zero, false);
                ...
                switch (eType)
                {
                    ...
                    case AkCallbackType.AK_Monitoring:
                        if (m_MonitoringCB != null)
                        {
                            ...
                            m_MonitoringCB(AkMonitoringCallbackInfo.errorCode, AkMonitoringCallbackInfo.errorLevel,
                                AkMonitoringCallbackInfo.playingID, AkMonitoringCallbackInfo.gameObjID,
                                AkMonitoringCallbackInfo.message);
                        }
#if UNITY_EDITOR
                    ...
                    case AkCallbackType.AK_Bank:
                        ...
                        if (bankPkg != null && bankPkg.m_Callback != null)
                        {
                            ...
                            bankPkg.m_Callback(AkBankCallbackInfo.bankID, AkBankCallbackInfo.inMemoryBankPtr,
                                AkBankCallbackInfo.loadResult, bankPkg.m_Cookie);
                        }
                    ...
                    default:
                        ...
                        switch (eType)
                        {
                            ...
                            default:
                                UnityEngine.Debug.LogError("WwiseUnity: Undefined callback type <" + eType +
                                                           "> received. Callback object possibly corrupted.");
                                break;
                        }
