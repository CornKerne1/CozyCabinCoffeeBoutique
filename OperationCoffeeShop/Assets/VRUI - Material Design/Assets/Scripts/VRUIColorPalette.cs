...
namespace SpaceBear.VRUI
{
	...
	public class VRUIColorPalette : MonoBehaviour
	{
		...
		public void UpdateColors()
		{
			...
			{
				ColorBlock colors = btnIcon.GetComponent<UnityEngine.UI.Button>().colors;

				btnIcon.GetComponent<UnityEngine.UI.Button>().colors = SetColorBlockFromTheme(colors);
			}
			...
			foreach (GameObject tab in tabBtns)
			{
				...
				ColorBlock colors = tab.GetComponent<UnityEngine.UI.Button>().colors;
			...
			{
				ColorBlock colors = control.GetComponent<UnityEngine.UI.Button>().colors;
			...
			{
				ColorBlock colors = listBtn.GetComponent<UnityEngine.UI.Button>().colors;

				listBtn.GetComponent<UnityEngine.UI.Button>().colors = SetColorBlockFromTheme(colors);
			}
