	...
	public class HierarchyFolderPreferences : ScriptableObject, ISerializationCallbackReceiver
	{
        ...
        private void OnEnable()
		{
			...
			if(modernDark.closed == null)
			{
				...
				{
					#if DEV_MODE
					UnityEngine.Debug.Log("HierarchyFolderPreferences.OnEnable - loading default icons failed with EditorApplication.isUpdating=" + EditorApplication.isUpdating+ ", defaultIconGuids:" + defaultIconGuids.Length + ". Retrying after a delay...");
					#endif
					EditorApplication.delayCall += OnEnable;
					return;
				}

				UnityEngine.Debug.LogWarning("HierarchyFolderPreferences.OnEnable - loading default icons failed with EditorApplication.isUpdating=" + EditorApplication.isUpdating+ ", defaultIconGuids:" + defaultIconGuids.Length + ".");
			}
