...
{
	/// <summary>
	/// Handles drawing project settings view for Hierarchy Folders in window that can be opened via "Edit > Project Settings...".
	/// </summary>
	public static class HierarchyFolderSettingsProvider
	{
		...
		{
			var provider = new SettingsProvider("Project/Hierarchy Folders", SettingsScope.Project)
			{
